...
class GoogleRequest:
    def __call__(self, model_id: str, data: Dict):
        try:
            ...
            shellscript_file_path = os.path.join(PROJECT_ROOT_DIR, "scripts/server/access_token.sh")
            bashscript_file_path = os.path.join(PROJECT_ROOT_DIR, "scripts", "server", "access_token.bash")
